#include "b3_capi_wrapper_no_gui.hpp"
...
b3CApiWrapperNoGui::b3CApiWrapperNoGui()
{
...
bool b3CApiWrapperNoGui::isConnected() const
{
	return (m_data->m_physicsClientHandle != 0);
}

void b3CApiWrapperNoGui::setTimeOut(double timeOutInSec)
{
	if (!isConnected())
	{
...
void b3CApiWrapperNoGui::disconnect()
{
	if (!isConnected())
	{
		b3Warning("Not connected");
...
void b3CApiWrapperNoGui::syncBodies()
{
	if (!isConnected())
	{
		b3Warning("Not connected");
...
void b3CApiWrapperNoGui::resetSimulation()
{
	if (!isConnected())
	{
		b3Warning("Not connected");
...
void b3CApiWrapperNoGui::resetSimulation(int flag)
{
	if (!isConnected())
	{
		b3Warning("Not connected");
...
bool b3CApiWrapperNoGui::canSubmitCommand() const
{
	if (!isConnected())
	{
		return false;
...
void b3CApiWrapperNoGui::stepSimulation()
{
	if (!isConnected())
	{
		b3Warning("Not connected");
...
void b3CApiWrapperNoGui::setGravity(const btVector3& gravityAcceleration)
{
	if (!isConnected())
	{
		b3Warning("Not connected");
...
btQuaternion b3CApiWrapperNoGui::getQuaternionFromEuler(const btVector3& rollPitchYaw)
{
	btQuaternion q;
...
btVector3 b3CApiWrapperNoGui::getEulerFromQuaternion(const btQuaternion& quat)
{
...
int b3CApiWrapperNoGui::loadTexture(const std::string& fileName)
{
	if (!isConnected())
	{
		b3Warning("Not connected");
...
bool b3CApiWrapperNoGui::changeVisualShape(const struct b3RobotSimulatorChangeVisualShapeArgs& args)
{
	if (!isConnected())
	{
		b3Warning("Not connected");
...
int b3CApiWrapperNoGui::loadURDF(const std::string& fileName, const struct b3RobotSimulatorLoadUrdfFileArgs& args)
{
	int robotUniqueId = -1;
...
bool b3CApiWrapperNoGui::loadMJCF(const std::string& fileName, b3RobotSimulatorLoadFileResults& results)
{
	if (!isConnected())
	{
		b3Warning("Not connected");
...
bool b3CApiWrapperNoGui::savePythonWorld(const std::string& fileName)
{
	if (!isConnected())
	{
		b3Warning("Not connected");
...
bool b3CApiWrapperNoGui::saveBullet(const std::string& fileName)
{
	if (!isConnected())
	{
		b3Warning("Not connected");
...
bool b3CApiWrapperNoGui::loadBullet(const std::string& fileName, b3RobotSimulatorLoadFileResults& results)
{
	if (!isConnected())
	{
		b3Warning("Not connected");
...
bool b3CApiWrapperNoGui::loadSDF(const std::string& fileName, b3RobotSimulatorLoadFileResults& results, const struct b3RobotSimulatorLoadSdfFileArgs& args)
{
	if (!isConnected())
	{
		b3Warning("Not connected");
...
bool b3CApiWrapperNoGui::getBodyInfo(int bodyUniqueId, struct b3BodyInfo* bodyInfo)
{
	if (!isConnected())
	{
		b3Warning("Not connected");
...
bool b3CApiWrapperNoGui::getBasePositionAndOrientation(int bodyUniqueId, btVector3& basePosition, btQuaternion& baseOrientation) const
{
	if (!isConnected())
	{
		b3Warning("Not connected");
...
bool b3CApiWrapperNoGui::resetBasePositionAndOrientation(int bodyUniqueId, const btVector3& basePosition, const btQuaternion& baseOrientation)
{
	if (!isConnected())
	{
		b3Warning("Not connected");
...
bool b3CApiWrapperNoGui::getBaseVelocity(int bodyUniqueId, btVector3& baseLinearVelocity, btVector3& baseAngularVelocity) const
{
	if (!isConnected())
	{
		b3Warning("Not connected");
...
bool b3CApiWrapperNoGui::resetBaseVelocity(int bodyUniqueId, const btVector3& linearVelocity, const btVector3& angularVelocity) const
{
	if (!isConnected())
	{
		b3Warning("Not connected");
...
void b3CApiWrapperNoGui::setInternalSimFlags(int flags)
{
	if (!isConnected())
	{
		b3Warning("Not connected");
...
void b3CApiWrapperNoGui::setRealTimeSimulation(bool enableRealTimeSimulation)
{
	if (!isConnected())
	{
		b3Warning("Not connected");
...
int b3CApiWrapperNoGui::getNumJoints(int bodyUniqueId) const
{
	if (!isConnected())
	{
		b3Warning("Not connected");
...
bool b3CApiWrapperNoGui::getJointInfo(int bodyUniqueId, int jointIndex, b3JointInfo* jointInfo)
{
	if (!isConnected())
	{
		b3Warning("Not connected");
...
int b3CApiWrapperNoGui::createConstraint(int parentBodyIndex, int parentJointIndex, int childBodyIndex, int childJointIndex, b3JointInfo* jointInfo)
{
	if (!isConnected())
	{
		b3Warning("Not connected");
...
int b3CApiWrapperNoGui::changeConstraint(int constraintId, b3RobotUserConstraint* jointInfo)
{
	if (!isConnected())
	{
		b3Warning("Not connected");
...
void b3CApiWrapperNoGui::removeConstraint(int constraintId)
{
	if (!isConnected())
	{
		b3Warning("Not connected");
...
bool b3CApiWrapperNoGui::getConstraintInfo(int constraintUniqueId, struct b3UserConstraint& constraintInfo)
{
	if (!isConnected())
	{
		b3Warning("Not connected");
...
bool b3CApiWrapperNoGui::getJointState(int bodyUniqueId, int jointIndex, struct b3JointSensorState* state)
{
	if (!isConnected())
	{
		b3Warning("Not connected");
...
bool b3CApiWrapperNoGui::getJointStates(int bodyUniqueId, b3JointStates2& state)
{
	if (!isConnected())
	{
		b3Warning("Not connected");
...
bool b3CApiWrapperNoGui::resetJointState(int bodyUniqueId, int jointIndex, double targetValue)
{
	if (!isConnected())
	{
		b3Warning("Not connected");
...
void b3CApiWrapperNoGui::setJointMotorControl(int bodyUniqueId, int jointIndex, const b3RobotSimulatorJointMotorArgs& args)
{
	if (!isConnected())
	{
		b3Warning("Not connected");
...
void b3CApiWrapperNoGui::setNumSolverIterations(int numIterations)
{
	if (!isConnected())
	{
		b3Warning("Not connected");
...
void b3CApiWrapperNoGui::setContactBreakingThreshold(double threshold)
{
	if (!isConnected())
	{
		b3Warning("Not connected");
...
void b3CApiWrapperNoGui::setTimeStep(double timeStepInSeconds)
{
	if (!isConnected())
	{
		b3Warning("Not connected");
...
void b3CApiWrapperNoGui::setNumSimulationSubSteps(int numSubSteps)
{
	if (!isConnected())
	{
		b3Warning("Not connected");
...
bool b3CApiWrapperNoGui::calculateInverseKinematics(const struct b3RobotSimulatorInverseKinematicArgs& args, struct b3RobotSimulatorInverseKinematicsResults& results)
{
	if (!isConnected())
	{
		b3Warning("Not connected");
...
int b3CApiWrapperNoGui::computeDofCount(int bodyUniqueId) const
{
	if (!isConnected())
	{
		b3Warning("Not connected");
...
int b3CApiWrapperNoGui::calculateMassMatrix(int bodyUniqueId, const double* jointPositions, int numJointPositions, double* massMatrix, int flags)
{
	if (!isConnected())
	{
		b3Warning("Not connected");
...
bool b3CApiWrapperNoGui::getBodyJacobian(int bodyUniqueId, int linkIndex, const double* localPosition, const double* jointPositions, const double* jointVelocities, const double* jointAccelerations, double* linearJacobian, double* angularJacobian)
{
	if (!isConnected())
	{
		b3Warning("Not connected");
...
bool b3CApiWrapperNoGui::getLinkState(int bodyUniqueId, int linkIndex, int computeLinkVelocity, int computeForwardKinematics, b3LinkState* linkState)
{
	if (!isConnected())
	{
		b3Warning("Not connected");
...
void b3CApiWrapperNoGui::configureDebugVisualizer(b3ConfigureDebugVisualizerEnum flag, int enable)
{
	if (!isConnected())
	{
		b3Warning("Not connected");
...
void b3CApiWrapperNoGui::getVREvents(b3VREventsData* vrEventsData, int deviceTypeFilter)
{
...
void b3CApiWrapperNoGui::getKeyboardEvents(b3KeyboardEventsData* keyboardEventsData)
{
...
int b3CApiWrapperNoGui::startStateLogging(b3StateLoggingType loggingType, const std::string& fileName, const btAlignedObjectArray<int>& objectUniqueIds, int maxLogDof)
{
	if (!isConnected())
	{
		b3Warning("Not connected");
...
void b3CApiWrapperNoGui::stopStateLogging(int stateLoggerUniqueId)
{
	if (!isConnected())
	{
		b3Warning("Not connected");
...
void b3CApiWrapperNoGui::resetDebugVisualizerCamera(double cameraDistance, double cameraPitch, double cameraYaw, const btVector3& targetPos)
{
	if (!isConnected())
	{
		b3Warning("Not connected");
...
void b3CApiWrapperNoGui::submitProfileTiming(const std::string& profileName)
{
	if (!isConnected())
	{
		b3Warning("Not connected");
...
void b3CApiWrapperNoGui::loadSoftBody(const std::string& fileName, const struct b3RobotSimulatorLoadSoftBodyArgs& args)
{
	if (!isConnected())
	{
		b3Warning("Not connected");
...
void b3CApiWrapperNoGui::loadDeformableBody(const std::string& fileName, const struct b3RobotSimulatorLoadDeformableBodyArgs& args)
{
	if (!isConnected())
	{
		b3Warning("Not connected");
...
void b3CApiWrapperNoGui::getMouseEvents(b3MouseEventsData* mouseEventsData)
{
...
bool b3CApiWrapperNoGui::getCameraImage(int width, int height, struct b3RobotSimulatorGetCameraImageArgs args, struct b3CameraImageData& imageData)
{
	if (!isConnected())
	{
		b3Warning("Not connected");
...
bool b3CApiWrapperNoGui::calculateInverseDynamics(int bodyUniqueId, double* jointPositions, double* jointVelocities,
...
int b3CApiWrapperNoGui::getNumBodies() const
{
	if (!isConnected())
	{
		b3Warning("Not connected");
...
int b3CApiWrapperNoGui::getBodyUniqueId(int bodyId) const
{
	if (!isConnected())
	{
		b3Warning("Not connected");
...
bool b3CApiWrapperNoGui::removeBody(int bodyUniqueId)
{
	if (!isConnected())
	{
		b3Warning("Not connected");
...
bool b3CApiWrapperNoGui::getDynamicsInfo(int bodyUniqueId, int linkIndex, b3DynamicsInfo* dynamicsInfo)
{
	if (!isConnected())
	{
		b3Warning("Not connected");
...
bool b3CApiWrapperNoGui::changeDynamics(int bodyUniqueId, int linkIndex, struct b3RobotSimulatorChangeDynamicsArgs& args)
{
	b3PhysicsClientHandle sm = m_data->m_physicsClientHandle;
	if (sm == 0)
	{
...
int b3CApiWrapperNoGui::addUserDebugParameter(const char* paramName, double rangeMin, double rangeMax, double startValue)
{
	b3PhysicsClientHandle sm = m_data->m_physicsClientHandle;
	if (sm == 0)
	{
...
double b3CApiWrapperNoGui::readUserDebugParameter(int itemUniqueId)
{
	b3PhysicsClientHandle sm = m_data->m_physicsClientHandle;
	if (sm == 0)
	{
...
bool b3CApiWrapperNoGui::removeUserDebugItem(int itemUniqueId)
{
	b3PhysicsClientHandle sm = m_data->m_physicsClientHandle;
	if (sm == 0)
	{
...
int b3CApiWrapperNoGui::addUserDebugText(const char* text, double* textPosition, struct b3RobotSimulatorAddUserDebugTextArgs& args)
{
	b3PhysicsClientHandle sm = m_data->m_physicsClientHandle;
	if (sm == 0)
	{
...
int b3CApiWrapperNoGui::addUserDebugText(const char* text, btVector3& textPosition, struct b3RobotSimulatorAddUserDebugTextArgs& args)
{
	double dposXYZ[3];
...
int b3CApiWrapperNoGui::addUserDebugLine(double* fromXYZ, double* toXYZ, struct b3RobotSimulatorAddUserDebugLineArgs& args)
{
	b3PhysicsClientHandle sm = m_data->m_physicsClientHandle;
	if (sm == 0)
	{
...
int b3CApiWrapperNoGui::addUserDebugLine(btVector3& fromXYZ, btVector3& toXYZ, struct b3RobotSimulatorAddUserDebugLineArgs& args)
{
	double dfromXYZ[3];
	double dtoXYZ[3];
...
bool b3CApiWrapperNoGui::setJointMotorControlArray(int bodyUniqueId, struct b3RobotSimulatorJointMotorArrayArgs& args)
{
	b3PhysicsClientHandle sm = m_data->m_physicsClientHandle;
	if (sm == 0)
	{
...
bool b3CApiWrapperNoGui::getPhysicsEngineParameters(struct b3RobotSimulatorSetPhysicsEngineParameters& args)
{
	b3PhysicsClientHandle sm = m_data->m_physicsClientHandle;
	if (sm == 0)
	{
...
bool b3CApiWrapperNoGui::setPhysicsEngineParameter(const struct b3RobotSimulatorSetPhysicsEngineParameters& args)
{
	b3PhysicsClientHandle sm = m_data->m_physicsClientHandle;
	if (sm == 0)
	{
...
bool b3CApiWrapperNoGui::applyExternalForce(int objectUniqueId, int linkIndex, double* force, double* position, int flags)
{
	b3PhysicsClientHandle sm = m_data->m_physicsClientHandle;
	if (sm == 0)
	{
...
bool b3CApiWrapperNoGui::applyExternalForce(int objectUniqueId, int linkIndex, btVector3& force, btVector3& position, int flags)
{
	double dforce[3];
	double dposition[3];
...
bool b3CApiWrapperNoGui::applyExternalTorque(int objectUniqueId, int linkIndex, double* torque, int flags)
{
	b3PhysicsClientHandle sm = m_data->m_physicsClientHandle;
	if (sm == 0)
	{
...
bool b3CApiWrapperNoGui::applyExternalTorque(int objectUniqueId, int linkIndex, btVector3& torque, int flags)
{
	double dtorque[3];
...
bool b3CApiWrapperNoGui::enableJointForceTorqueSensor(int bodyUniqueId, int jointIndex, bool enable)
{
	b3PhysicsClientHandle sm = m_data->m_physicsClientHandle;
	if (sm == 0)
	{
...
bool b3CApiWrapperNoGui::getDebugVisualizerCamera(struct b3OpenGLVisualizerCameraInfo* cameraInfo)
{
	b3PhysicsClientHandle sm = m_data->m_physicsClientHandle;
	if (sm == 0)
	{
...
bool b3CApiWrapperNoGui::getContactPoints(struct b3RobotSimulatorGetContactPointsArgs& args, struct b3ContactInformation* contactInfo)
{
	b3PhysicsClientHandle sm = m_data->m_physicsClientHandle;
	if (sm == 0)
	{
...
bool b3CApiWrapperNoGui::getClosestPoints(struct b3RobotSimulatorGetContactPointsArgs& args, double distance, struct b3ContactInformation* contactInfo)
{
	b3PhysicsClientHandle sm = m_data->m_physicsClientHandle;
	if (sm == 0)
	{
...
bool b3CApiWrapperNoGui::getOverlappingObjects(double* aabbMin, double* aabbMax, struct b3AABBOverlapData* overlapData)
{
	b3PhysicsClientHandle sm = m_data->m_physicsClientHandle;
	if (sm == 0)
	{
...
bool b3CApiWrapperNoGui::getOverlappingObjects(btVector3& aabbMin, btVector3& aabbMax, struct b3AABBOverlapData* overlapData)
{
	double daabbMin[3];
	double daabbMax[3];
...
bool b3CApiWrapperNoGui::getAABB(int bodyUniqueId, int linkIndex, double* aabbMin, double* aabbMax)
{
	b3PhysicsClientHandle sm = m_data->m_physicsClientHandle;
	if (sm == 0)
	{
...
bool b3CApiWrapperNoGui::getAABB(int bodyUniqueId, int linkIndex, btVector3& aabbMin, btVector3& aabbMax)
{
	double daabbMin[3];
	double daabbMax[3];
...
int b3CApiWrapperNoGui::createVisualShape(int shapeType, struct b3RobotSimulatorCreateVisualShapeArgs& args)
{
	b3PhysicsClientHandle sm = m_data->m_physicsClientHandle;
	if (sm == 0)
	{
...
int b3CApiWrapperNoGui::createCollisionShape(int shapeType, struct b3RobotSimulatorCreateCollisionShapeArgs& args)
{
	b3PhysicsClientHandle sm = m_data->m_physicsClientHandle;
	if (sm == 0)
	{
...
int b3CApiWrapperNoGui::createMultiBody(struct b3RobotSimulatorCreateMultiBodyArgs& args)
{
	b3PhysicsClientHandle sm = m_data->m_physicsClientHandle;
	if (sm == 0)
	{
...
int b3CApiWrapperNoGui::getNumConstraints() const
{
	if (!isConnected())
	{
		b3Warning("Not connected");
...
int b3CApiWrapperNoGui::getConstraintUniqueId(int serialIndex)
{
	if (!isConnected())
	{
		b3Warning("Not connected");
...
void b3CApiWrapperNoGui::setGuiHelper(struct GUIHelperInterface* guiHelper)
{
	m_data->m_guiHelper = guiHelper;
}

struct GUIHelperInterface* b3CApiWrapperNoGui::getGuiHelper()
{
	return m_data->m_guiHelper;
}

void b3CApiWrapperNoGui::setInternalData(struct b3RobotSimulatorClientAPI_InternalData* data)
{
	*m_data = *data;
}

bool b3CApiWrapperNoGui::getCollisionShapeData(int bodyUniqueId, int linkIndex,
...
int b3CApiWrapperNoGui::saveStateToMemory()
{
	b3PhysicsClientHandle sm = m_data->m_physicsClientHandle;
	if (sm == 0)
	{
...
void b3CApiWrapperNoGui::restoreStateFromMemory(int stateId)
{
	b3PhysicsClientHandle sm = m_data->m_physicsClientHandle;
	if (sm == 0)
	{
...
bool b3CApiWrapperNoGui::getVisualShapeData(int bodyUniqueId, b3VisualShapeInformation& visualShapeInfo)
{
	b3PhysicsClientHandle sm = m_data->m_physicsClientHandle;
	if (sm == 0)
	{
...
void b3CApiWrapperNoGui::setAdditionalSearchPath(const std::string& path)
{
	int physicsClientId = 0;
	b3PhysicsClientHandle sm = m_data->m_physicsClientHandle;
	if (sm == 0)
...
void b3CApiWrapperNoGui::setCollisionFilterGroupMask(int bodyUniqueIdA, int linkIndexA, int collisionFilterGroup, int collisionFilterMask)
{
    int physicsClientId = 0;
    b3PhysicsClientHandle sm = m_data->m_physicsClientHandle;
    if (sm == 0)
...
bool b3CApiWrapperNoGui::connect(int mode, const std::string& hostName, int portOrKey)
{
