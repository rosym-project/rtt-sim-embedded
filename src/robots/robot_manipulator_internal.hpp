...
private:
    ...
    RTT::OutputPort<Eigen::VectorXd> out_position_fdb;
    Eigen::VectorXd out_position_fdb_var;

    RTT::OutputPort<Eigen::VectorXd> out_velocities_fdb;
    Eigen::VectorXd out_velocities_fdb_var;
};
